...
jQuery(document).ready(function($) {
    ...
    $(".gray").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/gray.css");
        $.cookie('layout_color', 'css/colors/gray.css');
        return false;
    });

    $(".green").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/green.css");
        $.cookie('layout_color', 'css/colors/green.css');
        return false;
    });

    $(".blue").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/blue.css");
        $.cookie('layout_color', 'css/colors/blue.css');
        return false;
    });

    $(".red").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/red.css");
        $.cookie('layout_color', 'css/colors/red.css');
        return false;
    });

    $(".yellow").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/yellow.css");
        $.cookie('layout_color', 'css/colors/yellow.css');
        return false;
    });

    $(".DarkBlue").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/DarkBlue.css");
        $.cookie('layout_color', 'css/colors/DarkBlue.css');
        return false;
    });

    $(".orange").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/orange.css");
        $.cookie('layout_color', 'css/colors/orange.css');
        return false;
    });

    $(".rose").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/rose.css");
        $.cookie('layout_color', 'css/colors/rose.css');
        return false;
    });

    $(".lightseagreen").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/lightseagreen.css");
        $.cookie('layout_color', 'css/colors/lightseagreen.css');
        return false;
    });

    $(".darkolivegreen").click(function() {
        $("#colors-style").attr("href", "/laravel/public/home/jianli/css/colors/darkolivegreen.css");
