...
@section('contents')
    ...
    <div class="col-lg-12 col-md-12 col-sm-3 col-xs-12 ">
         ...
         <div class="image-holder one" id="pic_prof_1" style="display:block">
                ...
                <img class="head-image up circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image up-left circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image left circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image down-left circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image down circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image down-right circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image right circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image up-right circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
                <img class="head-image front circle" src="{{url('home/jianli/images/img/11.png')}}" width="150" height="150" alt="" />
    ...
    <div class="col-lg-12 col-md-12 col-sm-9 col-xs-12">
        ...
        <!-- Profile info -->
        <div id="profile_info">
            <h1 id="name" class="transition-02">李滕</h1>
        ...
        <div class="title_content">
           ...
           <ul class="about">
            ...
            <li>
                ...
                <label>出生日期</label>
                <span class="value">2月4日, 1992年</span>
                <div class="clear"></div>
            </li>
            ...
            <li>
                ...
                <label>邮箱</label>
                <span class="value">shidaibenyi@163.com</span>
                <div class="clear"></div>
            </li>
            ...
            <li>
                ...
                <label>电话</label>
                <span class="value">+86 18904046568</span>
                <div class="clear"></div>
            </li>
   ...
   <!-- .resume-right -->
    <div class="col-md-6">
        ...
        <div class="skills">       
           ...
           <!-- .skillbar -->
            <div class="skillbar clearfix " data-percent="70%">
                <div class="skillbar-title"><span>CAD</span></div>
                <div class="skillbar-bar"></div>
                <div class="skill-bar-percent">ACD</div>
            </div>
            <!-- /.skillbar -->            
    ...
    <div class="col-md-6 resume-left">    
        ...
        <div class="title_content" style="margin-bottom:5px">
            <div class="text_content">实践与工作经验</div>
            <div class="clear"></div>
        </div>
        <!-- /.title_content -->
        ...
        <ul class="attributes">
            <li class="first">
                <h5>电商二次开发(PHPer)<span class="duration"><i class="fa fa-calendar color"></i> 2011 - 2011</span></h5>
                <h6><span class="fa fa-briefcase"></span>沈阳工业大学.</h6>
                <p>沈阳工业大学金属工艺实习</p>

            </li>
            <li>
                <h5>大客户助理 <span class="duration"><i class="fa fa-calendar color"></i> 2013 - 2013</span></h5>
                <h6><span class="fa fa-briefcase"></span> 长春一汽公司</h6>
                <p>长春一汽公司与哈尔滨电机厂课程认知实习；<p>
...
<div class="reference clearfix"> 
        ...
        <ul>
            <li class="clearfix">
                <img src="{{url('home/jianli/images/portfolio/1.jpg')}}" class="img_reference" width="100" height="100" alt="">
                <p>“作为一个已经在社会上工作接近一年的人，我可以熟练使用CAD并可以用很多快捷键来快速画图，掌握并熟练应用EXCEL比如sumif，vlookup函数的使用。也在学习solidworks，3dmax,PS等软件以提高自己的竞争力，希望我可以得到一个面试的机会！ </span>
            </li>
                            ...
                            <div class="col-md-12 post_content">
                                <div class="content post_format_standart">
                                    <div class="top_c ">
                                        ...
                                        <div class="title_content">
                                            <div class="text_content"><a href="{{url('/blog')}}/2" class="read_more">认真参加两学一做</a></div>
                                            <div class="clear"></div>
                                        </div>

                                        <ul class="info">
                                            <li><i class="glyphicon glyphicon-comment"></i> 2 Comments</li>
                                            <li><i class="glyphicon glyphicon-time"></i> 07 07, 2016</li>
                                            <li><i class="glyphicon glyphicon-user"></i> by <a href="{{url('/list')}}?user=1">李滕</a></li>
                                          
                                        </ul>

                                        <div class="blog-content">
                                            <p><i class="fa fa-quote-left"></i> 他和她他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦他和她住在同一栋楼哦住在同一栋楼哦。...</p></div>
                                    </div>
                                </div>  

                                <a href="{{url('/blog')}}/15" >Read More <i class='glyphicon glyphicon-chevron-right'></i></a>
                                                ...
                                                <div class="row" id="contact-user">
                                                    <div class="col-md-5">
                                                        <div class="contact-info">
                                                            ...
                                                            <ul>
                                                                <li><span class="span-info"><i class="glyphicon glyphicon-map-marker"></i> 地址:</span> 北京 ----,中国.<br /></li>
                                                                <li><span class="span-info"><i class="glyphicon glyphicon-envelope"></i> 邮箱:</span> shidaibenyi@163.com</li>
                                                                <li><span class="span-info"><i class="glyphicon glyphicon-phone"></i> 联系电话:</span> +86 18904046568</li>   
                                                                <li><span class="span-info"><i class="glyphicon glyphicon-comment"></i> 微信:</span> shidaibenyi</li>
...
<img src="{{url('home/jianli/images/spinner.gif')}}" height="66%" width="77%">
