...
<head>
  ...
  <link rel="shortcut icon" href="#" type="../public/image/png">
  ...
  <!--莫里斯图表 -->
  <link rel="stylesheet" href="./public/laravel/public//js/morris-chart/morris.css">
        ...
        <!-- 侧边栏开始 -->
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>用户界面</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="general.blade.php"> 用户列表 </a></li>
                ...
                <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>评论</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/admin/comment/"> 基本信息 </a></li>
                        <li><a href="/admin/comment/add"> 添加评论 </a></li>
                    </ul>
                </li>
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="../public/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="../public/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="../public/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="../public/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="../public/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="../public/images/photos/user2.png" alt=""/>
                                </a>
